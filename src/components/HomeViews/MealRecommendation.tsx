            ...
            <div className="flex gap-2 mb-8 bg-slate-50 p-1 rounded-full w-max">
              {tabs.map(tab => (
                <button
                  ...
                  className={`px-5 py-2 rounded-full text-sm font-medium transition-all flex items-center gap-1.5 ${activeTab === tab.name ? 'bg-white text-slate-900 shadow-sm' : 'text-slate-500 hover:text-slate-800'
                    }`}
                >
            ...
            <AnimatePresence mode="popLayout">
              ...
              >
                ...
                <div className="flex items-center gap-4 bg-orange-50/50 p-4 rounded-2xl mb-6">
                  <img src={localMedia.scenes.mealBowl} alt="Meal" className="w-16 h-16 rounded-full shadow-sm object-cover" />
                  <div>
          ...
          <div className="flex-1 w-full relative flex justify-center mt-10 lg:mt-0">
            ...
            >
              ...
              <div className="relative mb-4">
                <img src={localMedia.scenes.analysis} alt="Analysis" className="w-full h-48 object-cover rounded-2xl" />
